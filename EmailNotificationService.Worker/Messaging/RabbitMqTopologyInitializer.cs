...
/// on startup. Declarations are idempotent, so it is safe to run this regardless of whether
/// the Api or the Worker process starts first. Runs with a small connection retry loop since
/// the broker (typically started via docker compose) may not be ready the instant this
/// process starts.
/// </summary>
